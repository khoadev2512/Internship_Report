...
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (1, 'John', 20, '123 Main St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (2, 'Alice', 22, '456 Elm St'); 
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (3, 'Bob', 21, '789 Oak St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (4, 'Paul', 14, '5 Cong Hoa St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (5, 'Faker', 27, '100 Song Hanh St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (6, 'Paul', 14, '125 Cong Hoa St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (7, 'Sakura', 14, '2305 Cong Hoa St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (8, 'Naruto', 14, '1356 Cong Hoa St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (9, 'Xayah', 14, '1093 Cong Hoa St');
INSERT INTO STUDENTS (ID, NAME, AGE, ADDRESS) VALUES (10, 'Sarah', 23, '321 Pine St');*/
...
CREATE TABLE CUSTOMER (
    ...
    GRADE DECIMAL(10,2), -- Use DECIMAL instead of NUMBER
...
CREATE TABLE ORDERS (
    ORD_NUM INT(6) NOT NULL PRIMARY KEY, -- Use INT for the "ORD_NUM"
    ORD_AMOUNT DECIMAL(12,2) NOT NULL, -- Use DECIMAL instead of NUMBER
    ADVANCE_AMOUNT DECIMAL(12,2) NOT NULL, -- Use DECIMAL instead of NUMBER
    ORD_DATE DATE NOT NULL,
    CUST_CODE VARCHAR(6) NOT NULL,
    AGENT_CODE CHAR(6) NOT NULL,
    ORD_DESCRIPTION VARCHAR(60) NOT NULL,
    FOREIGN KEY (CUST_CODE) REFERENCES CUSTOMER (CUST_CODE), -- Specify the referenced table and column
    FOREIGN KEY (AGENT_CODE) REFERENCES AGENTS (AGENT_CODE) -- Specify the referenced table and column
);
